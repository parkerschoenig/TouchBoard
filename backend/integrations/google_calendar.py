...
def _demo_events() -> dict:
    """Invented upcoming events anchored to today so the demo always looks current."""
    ...
    events = [
        {"title": "Rent due", "start": day(2), "all_day": True},
        {"title": "Internet bill", "start": day(3), "all_day": True},
        {"title": "Team standup", "start": at(1, 9, 30), "all_day": False},
        {"title": "Dentist appointment", "start": at(4, 14, 0), "all_day": False},
        {"title": "Electric bill", "start": day(6), "all_day": True},
        {"title": "Project deadline", "start": at(7, 17, 0), "all_day": False},
        {"title": "Car insurance", "start": day(10), "all_day": True},
        {"title": "Lunch with Alex", "start": at(11, 12, 30), "all_day": False},
        {"title": "Streaming subscription", "start": day(14), "all_day": True},
        {"title": "Quarterly review", "start": at(18, 10, 0), "all_day": False},
        {"title": "Phone bill", "start": day(21), "all_day": True},
        {"title": "Weekend trip", "start": day(24), "all_day": True},
        {"title": "Credit card payment", "start": day(28), "all_day": True},
    ]
